...
As well as a couple keybind and window rule changes in hypr/config. Kitty cursor tail visual effect, etc.
...
- Editor: Neovim (Minimal setup)
    ...
    - Built-in code/terminal split view for testing Python code quickly without leaving Neovim.
        - (Keybind for open file: Space+r+r. Navigate between terminal and code panes with Ctl+h and Ctl+l, i to type in terminal, Esc to leave terminals "insert mode".)
